...
class EnvioDatasForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['dia'].widget.attrs.update({'class': 'mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm sm:text-base bg-white'})

        self.fields['mes'].label = 'Mês'
        self.fields['mes'].widget.attrs.update({'class': 'mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm sm:text-base bg-white'})

        self.fields['ano'].label = 'Ano'
        self.fields['ano'].widget.attrs.update({'class': 'mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm sm:text-base bg-white'})

        self.fields['unidade'].label = 'Unidade de Trabalho'
        self.fields['unidade'].widget.attrs.update({'class': 'mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm sm:text-base bg-white'})

        self.fields['carga_horaria'].label = 'Horas'
        self.fields['carga_horaria'].widget.attrs.update({'class': 'mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm sm:text-base bg-white'})
